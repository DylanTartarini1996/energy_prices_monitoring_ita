...
class ElectricityPrices():
    ...
    def __init__(self):
        ...
        self.zip_url = "https://www.mercatoelettrico.org/it/MenuBiblioteca/Documenti/Anno2023.zip"
    ...
    def get_hist_data(self):
        ...
        hist_df = pd.read_csv("../energy_prices_monitoring_ita/data/hist_pun.csv", index_col=0, parse_dates=True)
